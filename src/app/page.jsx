...
const HomePage = () => {
  return (
    <main className='flex flex-col justify-center align-middle text-center py-16 lg:px-48 px-12'>
      ...
      <h1 className='text-blue-950 text-4xl font-bold my-8'>Hola, soy Andrea Olivos, desarrolladora web full stack :)</h1>
      ...
      <span className="mt-10 cursor-pointer">
        <Link className="bg-purple-300 text-blue-950 text-lg font-bold px-6 py-4 rounded-full border-2 border-dashed border-purple-500 drop-shadow-md" href="mailto:andrea.olivos.b@gmail.com"><FontAwesomeIcon icon={faEnvelope} className="me-2" />Contáctame</Link>
      </span>
    </main>
  )
}
